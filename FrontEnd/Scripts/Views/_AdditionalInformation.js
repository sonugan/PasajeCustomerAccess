...
var homeAddressModal = (function () {
    ...
    initComponentsHomeAddress = function () {
        ...
        $('#btnSaveModalHAddress').on('click', function () {
            AnalyticsEventManager.sendChangeEvent("Policies", "Update Personal Address")      
...
var legalAddressModal = (function () {
    ...
    initComponentsLegalAddress = function () {
        ...
        $('#btnSaveModalLAddress').on('click', function () {
            AnalyticsEventManager.sendChangeEvent("Policies", "Update Bussiness Address")
...
var correspondenceAddressModal = (function () {
    ...
    initComponentsCorrespondenceAddress = function () {
        ...
        $('#btnSaveModalCAddress').on('click', function () {
            AnalyticsEventManager.sendChangeEvent("Policies", "Update Post Address")
...
var mailModal = (function () {
    ...
    initComponentsMail = function () {
        ...
        $('#btnSaveModalMail').on('click', function () {
            AnalyticsEventManager.sendChangeEvent("Policies", "Update Email")
            // Compruebo que se halla tildado el checkbox.
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (!result.Success) {
                            ...
                            $("#modalInfoText").empty();
                            $("#modalInfoText").append("La solicitud ha sido generada con el número " + result.Data.RequestNumber + ". Estaremos enviando un mail a la casilla informada para validar su correo electrónico.");
                            $("#modalInfo").modal({
                                backdrop: 'static',
                                keyboard: false
                            });
...
var modalHPhone = (function () {
    ...
    initComponentsHPhone = function () {
        ...
        $('#btnSaveModalHPhone').on('click', function () {
            AnalyticsEventManager.sendChangeEvent("Policies", "Update Personal Phonenumber")              
            // Compruebo que se halla tildado el checkbox.
...
var modalCPhone = (function () {
    ...
    initComponentsCPhone = function () {
        ...
        $('#btnSaveModalCPhone').on('click', function () {
            AnalyticsEventManager.sendChangeEvent("Policies", "Update Celular Phonenumber")              
            // Compruebo que se halla tildado el checkbox.
...
var modalJPhone = (function () {
    ...
    initComponentsJPhone = function () {
        ...
        $('#btnSaveModalJPhone').on('click', function () {
            AnalyticsEventManager.sendChangeEvent("Policies", "Update Bussiness Phonenumber")              
            // Compruebo que se halla tildado el checkbox.
